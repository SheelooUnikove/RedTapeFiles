    ...
    <script>
        ...
        function getPageData() {
            ...
            if (strurl.indexOf("=") > 0) {
                ...
                ProductParams.EndIndex = $("#prdsDiv li").length+6;
        ...
        function Showproducts(results) {         
            ...
            for (var i = 0; i < results.length; i++) {
                ...
                $("#prdsDiv").append("<li><div class='product_list_thumb'><img src='images/website/product-page/RTS2642/210X241_1.png' /></div><div class='product_list_info'><div class='product_list_name'>" + results[i].ProductTitle + "</div><div class='product_list_price'>" + results[i].SalePrice + "</div></div></li>");
