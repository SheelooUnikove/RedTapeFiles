...
$(document).ready(function () {
	...
	if ($('.inner_nav').length != 0 && window.innerWidth<790) {
                $("nav").css({"padding-top":"37px"}); // for pages having inner nav
            }
    ...
    $(".look_pointer").mouseover(function () {

        $(this).parent().children(".look_pointer_redirect").fadeIn(500);
        $(this).parent().children(".look_pointer_line").fadeIn(500);
        $(this).parent().children(".look_pointer_info").fadeIn(500);

    });

    $(".look_pointer").mouseout(function () {

        console.log("yes");
        $(this).parent().children(".look_pointer_redirect").fadeOut(500);
        $(this).parent().children(".look_pointer_line").fadeOut(500);
        $(this).parent().children(".look_pointer_info").fadeOut(500);
    ...
    $(".whats_hot_btn").click(function () {
        ...
        if (whats_hot_flag == 0) {
			$(".whats_hot_container").css({"visibility":"visible"});
            ...
            $(".whats_hot_bg").fadeOut(500);
				...
				$(".whats_hot .nbs-flexisel-nav-left").css({"margin-top":"0px", "top":"50%","left":"10px"});
				$(".whats_hot .nbs-flexisel-nav-right").css({"margin-top":"0px","top":"50%","right":"10px"});
