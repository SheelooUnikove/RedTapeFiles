...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	<div class="right_container account_right trans">
		...
		<asp:LinkButton ID="lnk_EditProfile" runat="server" CssClass="edt_prfl" OnClick="lnk_EditProfile_Click" ValidationGroup="chkaddress">edit profile</asp:LinkButton>
				...
				<div class="updt_detl_form">
					<div class="updat_dtl_row">
						<div class="up_fill_bx_lft"><div class="updat_dtl_txt">first name</div><input runat="server" id="txt_UserFirstName" type="text"  class="acnt_form_select" maxlength="30"/>
                           <asp:RequiredFieldValidator ID="rvl_UserFirstName" runat="server" ErrorMessage="This field is Required" ControlToValidate="txt_UserFirstName" SetFocusOnError="true" ValidationGroup="chkaddress"></asp:RequiredFieldValidator>
						...
						<div class="up_fill_bx_rght"><div class="updat_dtl_txt">last name</div><input runat="server" id="txt_UserLastName" class="acnt_form_select" type="text"  maxlength="30"/>
                          <asp:RequiredFieldValidator ID="rvl_UserLastName" runat="server" ErrorMessage="This field is Required" ControlToValidate="txt_UserLastName" SetFocusOnError="true" ValidationGroup="chkaddress"></asp:RequiredFieldValidator>
		...
		<%--<div class="edt_prfl">edit profile</div>	--%>
		<asp:LinkButton ID="lnk_EditProfile_bottom" runat="server" CssClass="edt_prfl" OnClick="lnk_EditProfile_Click" ValidationGroup="editProfile">edit profile</asp:LinkButton>
